"""
Parses FotMob big chances created - Championship. 4-line blocks: rank, player, assists, big chances.

Usage:
    python3 format_fotmob_bigchances_championship.py
"""
import pandas as pd
import re

INPUT_FILE = "data/raw/championship_bigchances_fotmob_raw.txt"
OUTPUT_FILE = "data/clean/championship_bigchances_clean.csv"
