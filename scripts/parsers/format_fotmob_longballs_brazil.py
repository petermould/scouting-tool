"""
Parses FotMob long balls - Brazil Serie B. 4-line blocks: rank, player, success%, long balls/90.

Usage:
    python3 format_fotmob_longballs_brazil.py
"""
import pandas as pd
import re

INPUT_FILE = "data/raw/brazilserieb_longballs_fotmob_raw.txt"
OUTPUT_FILE = "data/clean/brazilserieb_longballs_clean.csv"
