"""
Parses FotMob accurate passes/90 - Brazil Serie B. 4-line blocks: rank, player, pass success%, passes/90.

Usage:
    python3 format_fotmob_accpasses_brazil.py
"""
import pandas as pd
import re

INPUT_FILE = "data/raw/brazilserieb_accpasses_fotmob_raw.txt"
OUTPUT_FILE = "data/clean/brazilserieb_accpasses_clean.csv"
LEAGUE_NAME = "Brazil Serie B"
SECONDARY_COL_NAME = "PassSuccess_pct"
...
while i < len(lines):
    ...
    secondary_value = float(secondary_match.group(1)) if secondary_match else None
