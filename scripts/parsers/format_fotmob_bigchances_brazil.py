"""
Parses FotMob big chances created - Brazil Serie B. 4-line blocks: rank, player, assists, big chances.

Usage:
    python3 format_fotmob_bigchances_brazil.py
"""
import pandas as pd
import re

INPUT_FILE = "data/raw/brazilserieb_bigchances_fotmob_raw.txt"
OUTPUT_FILE = "data/clean/brazilserieb_bigchances_clean.csv"
