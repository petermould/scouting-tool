"""
Parses FotMob chances created leaderboard. 4-line blocks: rank, player, chances/90, total.

Usage:
    python3 format_fotmob_chances.py
"""
import pandas as pd
import re

INPUT_FILE = "data/raw/ligue2_chances_fotmob_raw.txt"
OUTPUT_FILE = "data/clean/ligue2_chances_clean.csv"
LEAGUE_NAME = "Ligue 2"
