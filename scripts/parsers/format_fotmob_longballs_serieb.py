"""
Parses FotMob long balls - Serie B. 4-line blocks: rank, player, success%, long balls/90.

Usage:
    python3 format_fotmob_longballs_serieb.py
"""
import pandas as pd
import re

INPUT_FILE = "data/raw/serieb_longballs_fotmob_raw.txt"
OUTPUT_FILE = "data/clean/serieb_longballs_clean.csv"
LEAGUE_NAME = "Serie B"
