"""
Parses FotMob big chances created - Serie B. 4-line blocks: rank, player, assists, big chances.

Usage:
    python3 format_fotmob_bigchances_serieb.py
"""
import pandas as pd
import re

INPUT_FILE = "data/raw/serieb_bigchances_fotmob_raw.txt"
OUTPUT_FILE = "data/clean/serieb_bigchances_clean.csv"
LEAGUE_NAME = "Serie B"
