"""
Parses FotMob chances created - Serie B. 4-line blocks: rank, player, chances/90, total.

Usage:
    python3 format_fotmob_chances_serieb.py
"""
import pandas as pd
import re

INPUT_FILE = "data/raw/serieb_chances_fotmob_raw.txt"
OUTPUT_FILE = "data/clean/serieb_chances_clean.csv"
LEAGUE_NAME = "Serie B"
