"""
Parses FotMob big chances created leaderboard. 4-line blocks: rank, player, assists, big chances.

Usage:
    python3 format_fotmob_bigchances.py
"""
import pandas as pd
import re

INPUT_FILE = "data/raw/ligue2_bigchances_fotmob_raw.txt"
OUTPUT_FILE = "data/clean/ligue2_bigchances_clean.csv"
LEAGUE_NAME = "Ligue 2"
